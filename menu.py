...
class Menu1:
    def __init__(self,master):
        ...
        # self.but3 = Button(self.Inner_frame,text='ROOM ALLOCATION',font='Helvetica 10 bold',fg='red',bg='sky blue',width=25,command=self.room_allo)
        ...
        # image5 = Image.open("download2.jpg")
