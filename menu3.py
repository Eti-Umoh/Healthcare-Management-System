...
class Menu3:
    def __init__(self,master):
        ...
        self.but4.grid(row=0,column=1)
        self.but5 = Button(self.Inner_frame,text='PATIENT BILL',font='Helvetica 15 bold',fg='red',bg='sky blue',width=26,command=self.patient_bills)
        ...
        # image1 = Image.open("People-Patient-Male-icon2.png")
        ...
        # image2 = Image.open("record-book-pen-128741502.jpg")
        ...
        self.but9.grid(row=1,column=0)

        image4 = Image.open("static/istockphoto-1279341226-612x6122.jpg")
